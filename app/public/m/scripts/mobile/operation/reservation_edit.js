...
$(".ol").on("click",".rv_content_star",function(){
    $(this).toggleClass("rv_content_star--on");
    let pid = $(".ol_title").html()
    let tid = $(this).parent().parent().attr("tid")
...
$(".rv_box").on("click",".oCheckZone",function(){
    $(this).parent().find(".op_content_oCheck").toggleClass("oCkeck--checked");
    let pid = $(".ol_title").html()
    let tid = $(this).parent().attr("tid")
    let id = $(this).parent().attr("id")
    if($(this).parent().find(".op_content_oCheck").hasClass("oCkeck--checked")){
...
$(".o").on("click",".rv_content",function(){
    if(isEditing){
        selectArray = []
