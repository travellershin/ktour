...
function inflate_product(pArray){
    ...
    for (let i = 0; i < iArray.length; i++) {
        ...
        txt+= '<div class="pc" id="'+pArray[i]+'"><div class="pc_topper"><div class="pc_status"><div class="bgco_'+bgco+'"></div></div><p class="pc_area">'+area+'</p><p class="pc_product">'+name+'</p><p class="pc_category">'+category+'</p></div>'
        if(data.info.memo){
