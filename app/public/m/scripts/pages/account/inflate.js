...
function inflate_data(array){
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        txt+='<p class="a_item_cardIncome a_item--income">'+data.card.inc+'</p><p class="a_item_cardExpenditure a_item--exp">'+data.card.exp+'</p><p class="a_item_cashIncome a_item--income">'+data.cash.inc+'</p><p class="a_item_cashExpenditure a_item--exp">'+data.cash.exp+'</p></div>'
    }
    $(".a_contents").html(txt)
}
